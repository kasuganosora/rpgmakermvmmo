/*:
 * @plugindesc v2.0.0 MMO UI - 天堂2风格 Canvas UI 组件库（DDD 构建）。
 * @author MMO Framework
 *
 * 由 ui/build.js 自动生成 — 请勿直接编辑此文件。
 * 如需修改，请编辑 ui/ 目录下的各组件源文件后重新构建。
 *
 * 组件列表（47 个文件）：
 *   核心:       L2_Theme（主题色/绘制工具）, L2_Base（组件基类）
 *   布局:       L2_Divider, L2_Grid, L2_Layout, L2_Space
 *   基础:       L2_Button, L2_Icon, L2_Link, L2_Typography
 *   导航:       L2_Tabs, L2_Menu, L2_Dropdown, L2_Pagination, L2_Steps, L2_Breadcrumb
 *   窗口:       L2_SubWindow, L2_FullscreenWindow
 *   输入:       L2_Input, L2_InputNumber, L2_Select, L2_Checkbox, L2_Radio, L2_Switch, L2_Slider, L2_Textarea
 *   数据展示:   L2_List, L2_Table, L2_Card, L2_Progress, L2_Tag, L2_Badge, L2_Avatar, L2_Collapse, L2_Tooltip, L2_Tree, L2_Statistic, L2_Empty, L2_Loading, L2_ChatBubble
 *   反馈:       L2_Dialog, L2_Drawer, L2_Message, L2_Notification, L2_Alert, L2_Popconfirm
 *
 * 主题风格：暗色天堂2风格（背景 #0D0D1A，金色文字 #FFD700，白色文字 #E8E8E8）。
 * 所有渲染通过 RMMV Bitmap 的 Canvas Context 完成，无 DOM 依赖。
 * L2_Base 继承自 PIXI.Sprite，提供 bmp()/cw()/ch()/refresh()/update() 标准接口。
 */
